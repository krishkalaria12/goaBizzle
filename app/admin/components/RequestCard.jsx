...
const RequestCard = ({ property, onAccept, onReject }) => {
    const handleAccept = (id) => {
        //make the changes in the backend and referesh
    }
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md my-3">
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <p className="text-gray-700 mb-2">{property.user.fullName}</p>
        <p className="text-gray-700 mb-2">{property.user.email}</p>
        <p className="text-gray-700">{property.user.phoneNumber}</p>
      </div>
